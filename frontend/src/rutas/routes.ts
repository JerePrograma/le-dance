...
export const publicRoutes = [
  ...
  {
    path: "/unauthorized",
    Component: lazy(() => import("../paginas/Unauthorized")),
  },
];
...
export const adminRoutes = [
  {
    path: "/usuarios",
    Component: lazy(() => import("../funcionalidades/usuarios/UsuariosPagina")),
  },
  {
  ...
  {
    path: "/roles",
    Component: lazy(() => import("../funcionalidades/roles/RolesPagina")),
  },
  {
    path: "/roles/formulario",
    Component: lazy(() => import("../funcionalidades/roles/RolesFormulario")),
  },
];
...
export const otherProtectedRoutes = [
  ...
  {
    path: "/alumnos",
    Component: lazy(() => import("../funcionalidades/alumnos/AlumnosPagina")),
  },
  {
  ...
  {
    path: "/salones",
    Component: lazy(() => import("../funcionalidades/salones/SalonesPagina")),
  },
  {
    path: "/salones/formulario",
    Component: lazy(
  ...
  // Gestión de asistencias
  {
    ...
    Component: lazy(
      () =>
        import(
          "../funcionalidades/asistencias-diarias/AsistenciaDiariaFormulario"
        )
    ),
  },
  {
    path: "/asistencias-mensuales",
    Component: lazy(
      () =>
        import(
          "../funcionalidades/asistencias-mensuales/AsistenciaMensualDetalle"
        )
    ),
  },
  ...
  {
    path: "/caja",
    Component: lazy(() => import("../funcionalidades/caja/CajaPagina")),
  },
  {
    path: "/pagos-pendientes",
    Component: lazy(() => import("../funcionalidades/caja/PagosPendientes")),
  },
  {
    path: "/pagos-cobrados",
    Component: lazy(() => import("../funcionalidades/caja/PagosCobrados")),
  },
  {
    path: "/debitos",
    Component: lazy(() => import("../funcionalidades/caja/EgresoDebitoPagina")),
  },
  {
    path: "/caja/formulario",
    Component: lazy(() => import("../funcionalidades/caja/CajaFormulario")),
  },
  {
    path: "/cobranza/:alumnoId",
    Component: lazy(() => import("../funcionalidades/pagos/CobranzaPagina")),
  },
  {
    path: "/pagos/alumno/:alumnoId",
    Component: lazy(() => import("../funcionalidades/pagos/PagosAlumnoPagina")),
  },
  // Stocks y Tipo-Stocks
  {
    path: "/stocks",
    Component: lazy(() => import("../funcionalidades/stock/StocksPagina")),
  },
  {
    path: "/stocks/formulario",
    Component: lazy(() => import("../funcionalidades/stock/StocksFormulario")),
  },
  ...
  {
    path: "/conceptos/formulario-concepto",
    Component: lazy(
  ...
  {
    path: "/caja/diaria",
    Component: lazy(() => import("../funcionalidades/caja/ConsultaCajaDiaria")),
  },
  {
    path: "/caja/rendicion-mensual",
    Component: lazy(() => import("../funcionalidades/caja/RendicionMensual")),
  },
  // Recargos
  {
    path: "/recargos",
    Component: lazy(() => import("../funcionalidades/recargos/RecargosPagina")),
  },
  {
    path: "/recargos/formulario",
    Component: lazy(
