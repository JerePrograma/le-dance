...
const CajaFormulario = lazy(() => import("../funcionalidades/caja/CajaFormulario"));
const RendicionMensual = lazy(() => import("../funcionalidades/caja/RendicionMensual"));
    ...
    <Suspense fallback={<div>Cargando...</div>}>
      <Routes>
        ...
        <Route element={<ProtectedRoute />}>
          ...
          {/* Resto de las rutas protegidas sin restricción por rol */}
          ...
          <Route path="/caja/formulario" element={<CajaFormulario />} />
