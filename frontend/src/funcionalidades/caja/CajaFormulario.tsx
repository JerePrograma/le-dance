...
export default function PettyCash() {
    ...
    const handleFilter = async (values: { startDate: string; endDate: string }) => {
        try {
            const response = await api.get("/api/caja-chica", {
    ...
    return (
        <div className="w-full max-w-4xl mx-auto bg-white rounded-lg shadow-md">
            ...
            {/* Content */}
            <div className="p-4">
                {/* Formulario de filtrado integrado con Formik */}
                    ...
                    {({ isSubmitting }) => (
                        <Form className="flex flex-col sm:flex-row gap-4 mb-4 items-center">
                            <div className="flex items-center gap-2">
                                ...
                                <Field as={Input} type="date" name="startDate" className="w-40" />
                            </div>
                            <div className="flex items-center gap-2">
                                <span className="text-sm">Fecha Hasta:</span>
                                <Field as={Input} type="date" name="endDate" className="w-40" />
                            </div>
                        ...
                        <table className="w-full text-sm">
                            <thead>
                                ...
                                <tr className="border-b bg-gray-50/50">
                                    ...
                                    <th className="py-2 px-2 text-center">Nro</th>
                                    <th className="py-2 px-2 text-center">Importe</th>
                                    <th className="py-2 px-2 text-center">Nro</th>
                                    <th className="py-2 px-2 text-center">Importe</th>
                                </tr>
                            </thead>
...
// Componentes de íconos simples (se mantienen sin cambios)
const CalendarIcon = () => (
