...
export default function EgresosDebitoPagina() {
    ...
    const pageCount = useMemo(() => Math.ceil(egresos.length / itemsPerPage), [egresos.length])
    const currentItems = useMemo(
        () => egresos.slice(currentPage * itemsPerPage, (currentPage + 1) * itemsPerPage),
        [egresos, currentPage],
    )
                    ...
                    <div className="bg-black p-4 rounded shadow-md w-[300px]">
                        ...
                        <div className="mb-2">
                            ...
                            <input
                                ...
                                className="border p-2 w-full"
                                value={montoEgreso || ""}
                                onChange={(e) => setMontoEgreso(Number.parseFloat(e.target.value) || 0)}
                            />
                        </div>
                        <div className="mb-2">
