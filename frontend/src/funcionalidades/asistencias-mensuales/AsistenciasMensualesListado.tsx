// src/funcionalidades/asistencias-mensuales/AsistenciasMensualesListado.tsx
...
const AsistenciasMensualesListado: React.FC = () => {
...
export default AsistenciasMensualesListado;
