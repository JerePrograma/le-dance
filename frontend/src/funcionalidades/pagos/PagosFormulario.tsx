...
const DetallesTable: React.FC = () => {
  ...
  // Función auxiliar para separar la cadena "CONCEPTO - CUOTA - ALGO"
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              ...
              form.values.detallePagos.length > 0 ? (
                form.values.detallePagos.map((detalle: any, index: number) => {
                  // Si el detalle es autogenerado y se marcó como removido, no se renderiza
                    ...
                    <tr key={index} className="hover:bg-gray-50">
                      ...
                      <td className="border p-2 text-center text-sm">
                        <button
                          ...
                          onClick={() => {
                            // En lugar de eliminar el ítem, se marca como removido manualmente
                            form.setFieldValue(
                              `detallePagos.${index}.aCobrar`,
                              0
                            );
          ...
          if (descMayus.includes("MATRICULA")) {
            ...
            try {
              ...
              newDetails.push({
                ...
                removido: false, // Propiedad agregada
      ...
      if (selectedDisciplina) {
        ...
        if (isDuplicateString(conceptoDetalle)) {
          ...
          newDetails.push({
            ...
            valorBase: totalOriginal, // Valor base original
    ...
    try {
      ...
      const pagoRegistroRequest: PagoRegistroRequest = {
        ...
        detallePagos: detallePagos.map((d) => ({
          ...
          removido: d.removido || false, // Se envía el flag removido
        })),
        pagoMedios: [],
        observaciones: [
