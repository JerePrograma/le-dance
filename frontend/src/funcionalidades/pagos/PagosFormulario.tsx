        ...
        if (selectedConcept) {
          if (isDuplicate(selectedConcept.id)) {
            ...
            newDetails.push({
              ...
              // Se asigna importeInicial con el precio del concepto
        ...
        if (selectedDisciplina) {
          ...
          if (isDuplicateString(conceptoDetalle)) {
            ...
            newDetails.push({
              ...
              valorBase: total,
              // Se asigna importeInicial al total calculado
      ...
      >
        {({ values, setFieldValue }) => {
          ...
          const handleQuitarRecargo = useCallback(() => {
            ...
            setFieldValue("detallePagos", updatedDetalles);
            toast.info(
              "Recargo quitado. Los importes pendientes y a cobrar se reinician usando el importe inicial."
            );
