...
const mapDetallePagos = (
  ...
  const mapped = detallePendientes.map((det) => {
    // Se utiliza 'mensualidadId' si existe, de lo contrario el 'id'
...
export const useSyncDetalles = (alumnoData: AlumnoDataResponse | undefined) => {
  ...
  useEffect(() => {
    ...
    console.log(
      "[useSyncDetalles] Ejecutando hook con alumnoData:",
      alumnoData
    );
    console.log(
    ...
    // 1. Mapear los detalles pendientes obtenidos a formato del formulario.
