...
const mapDetallePagos = (
  ...
  return detallesPendientes.map((det) => {
    ...
    return {
      ...
      id: det.id,
      version: det.version,
      // Se envía la descripción completa sin truncarla
      descripcionConcepto: det.descripcionConcepto || "",
      conceptoId: det.conceptoId ?? null,
      subConceptoId: det.subConceptoId ?? null,
      cuotaOCantidad: det.cuotaOCantidad, // Se deja el valor tal como viene
      ...
      // Se asigna el tipo recibido o un valor por defecto
