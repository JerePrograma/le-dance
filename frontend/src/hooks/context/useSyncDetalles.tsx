...
const mapDetallePagos = (
  ...
  const mapped = detallePendientes.map((det) => {
    ...
    // Buscar si ya existe un detalle en el formulario con el idKey o que ya tenga asignado pagoId
    ...
    const mappedDetail: DetallePagoRegistroRequestExt = {
      ...
      pagoId: det.pagoId ?? null, // Se mapea el nuevo campo
    };
  ...
  useEffect(() => {
    ...
    if (manualDetails.length > 0) {
      ...
      const finalAutoDetails = autoDetailsFiltered.filter((autoDet) => {
        ...
        // Se puede comparar otros campos si no existe id
