...
public interface InscripcionMapper {
    ...
    @Mapping(target = "estado", source = "estado")
        // Se elimina la asignación de costoCalculado; se calculará desde el servicio.
    InscripcionResponse toDTO(Inscripcion inscripcion);

    // Para crear una inscripción a partir del nuevo DTO de registro
    ...
    // Para la bonificación, si se envía un id se mapea; de lo contrario, se asigna null
