...
-- (Opcional) Si deseas agregar restricciones o indices adicionales para auditoria o performance,
-- puedes incluirlos a continuacion. Por ejemplo, para asegurar que los importes nunca sean negativos:
ALTER TABLE detalle_pagos
...
-- Por ejemplo, si la tabla pagos se creo anteriormente, puedes verificar o ajustar:
ALTER TABLE pagos
