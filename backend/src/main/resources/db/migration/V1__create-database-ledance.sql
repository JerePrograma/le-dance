-- ========================================
-- UNIFICACIÓN DEFINITIVA DE LA ESTRUCTURA DE LA BASE DE DATOS
-- ========================================
...
-- ========================================
-- ACTUALIZACIONES V2 (DETALLE_PAGOS Y PAGO_MEDIOS)
-- ========================================

-- 20) CREAR TABLA DETALLE_PAGOS
...
(
    ...
    bonificacion    NUMERIC(10, 2) DEFAULT 0 CHECK (bonificacion >= 0),
...
-- 22) (Opcional) ÍNDICES PARA LAS NUEVAS TABLAS
CREATE INDEX idx_detalle_pagos_pago_id ON detalle_pagos (pago_id);
CREATE INDEX idx_pago_medios_pago_id ON pago_medios (pago_id);
CREATE INDEX idx_pago_medios_metodo_pago_id ON pago_medios (metodo_pago_id);
